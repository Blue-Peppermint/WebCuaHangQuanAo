...
<body>
	<div class="login-wrap">
		<div class="login-html">
			...
			<a href="home/login.htm" for="tab-1" class="tab"> <!-- <label
			...
			<div class="login-form">
				...
				<c:if test="${not empty message}">
					...
					<form:form action="home/register.htm" modelAttribute="userRegist"
						method= "post">
						<div class="group">
						...
						<div class="group">
							...
							<div class="row">
								<div class="col">
									<form:input path="pass" id="pass" type="password" class="input"
										data-type="password" />
								</div>
								<div class="col">
									<input name="repeatPassword" value="${repeatPasswordVal}" id="passRepeat" type="password"
						...
						<div class="group">
							<form:button id="registerBtn" class="button" >Đăng Ký</form:button>
						</div>
						<div class="hr"></div>
						<div class="foot-lnk">
							<!-- <label for="tab-1" id="alreadyMember">Đã có tài khoản?</a> -->
						</div>
					</form:form>
...
/* 	 var registerBtnEle = document.querySelector('#registerBtn')
		registerBtnEle.addEventListener('click',function(e){
			var user = ${userRegist}
			console.log(user)
